...
const usage = (exitCode = 1): never => {
  process.stderr.write(
    'LMS GitHub Desktop CLI usage: \n' +
      '  lms-github                            Open the current directory\n' +
      '  lms-github open [path]                Open the provided path\n' +
      '  lms-github clone [-b branch] <url>    Clone the repository by url or name/owner\n' +
